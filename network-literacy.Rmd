...
```{r, message=FALSE, warning=FALSE, echo=FALSE}
ggplot(data = tudors, aes(from_id = person_2, to_id = person_1)) +
  geom_net(aes(label = person_2), linewidth = 0.5, size = 6, 
...
lemisnetwork + geom_net(layout.alg = "fruchtermanreingold", vjust=-0.5, aes(label = from, linewidth = degree/5)) + theme_net()
```
